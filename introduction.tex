...
The spatially-resolved data can also be analyzed with a nonlinear fit to a reflectance equation derived from diffusion theory. The absorption and reduced scattering coefficients would act as input parameters for the equation. It is also possible to compare the obtained results to a databased of curves derived from Monte Carlo simulations.
...
Review currently available systems, their approaches, and approximate costs.
...
\begin{figure}
	...
	\caption[The major chromophores of skin within the visible light spectrum]{\label{fig:intro-skin_chromophores}The major chromophores found in skin within the visible light spectrum are oxy- and deoxy-hemoglobin and melanin. Data shown are from Jacques, XXXX.}
\end{figure}
