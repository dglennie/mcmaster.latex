...
\hypersetup{
    ...
    pdffitwindow=false,
    pdfstartview={FitV},
    pdftitle={Integrating sphere-based total diffuse reflectance spectroscopy for the quantification of hemoglobin in skin},
...
\title{Integrating sphere-based total diffuse reflectance spectroscopy for the quantification of hemoglobin in skin}
...
{\Large \uppercase{Integrating sphere-based total diffuse reflectance spectroscopy for the quantification of hemoglobin in skin}\\
\vfill
...
TITLE: Integrating sphere-based total diffuse reflectance spectroscopy for the quantification of hemoglobin in skin\\
