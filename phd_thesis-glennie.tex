...
\chapter{Paper II - The spectrally-constrained model}
%\include{chapter3}

\chapter{Paper III - Application in radiation therapy}
%\include{chapter4}\usepackage[style=numeric-comp,backend=biber,sorting=none,backref=true,maxnames=99,alldates=iso8601,refsection=chapter]{biblatex}

\chapter{Paper IV - TLD reproducibility}
%\include{chapter5}
