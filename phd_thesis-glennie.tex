...
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
    ...
    \begin{abstract} \thispagestyle{plain} \setcounter{page}{11} %This page number needs to be manually set properly after the tableofcontents is generated
