...
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
    ...
    \begin{abstract} \setcounter{page}{5} \thispagestyle{plain}
        ...
        To my family, friends, and colleagues who stood by me and provided support and stress-relief, especially during the final months\dots thank you. I love you, Mom \& Dad. To Dan, Jill, Judi, Nancy, and Rayna; Words cannot express my gratitude.
    \end{abstract}
